...
class PrivateChatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create private_chat" do
    assert_difference('PrivateChat.count') do
      post private_chats_url, params: { private_chat: { chatroom_id: @private_chat.chatroom_id, user_id: @private_chat.user_id } }
    end
  ...
  test "should update private_chat" do
    patch private_chat_url(@private_chat), params: { private_chat: { chatroom_id: @private_chat.chatroom_id, user_id: @private_chat.user_id } }
